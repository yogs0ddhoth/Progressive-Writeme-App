...
const {CacheableRosponsePlugin} = require('workbox-cacheable-response');
const {ExpirationPlugin} = require('workbox-expiration');
const {offlineFallback, warmStrategyCache} = require('workbox-recipes');
const {registerRoute} = require('workbox-routing');
// const {} = require('workbox-');
...
const pageCache = new CacheFirst( // configure cache-first strategy 
  { 
    ...
    plugins: [
      new CacheableRosponsePlugin( // cache all responses with '0' and '200' statuses
        { statuses: [0, 200] }
      ),
...
// add fetch listener to html navigation to implement runtime cache-first strategy
